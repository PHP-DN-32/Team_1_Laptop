		...
		<table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable" id="checkAll">
			...
			<tbody class="list_item">
					...
					<div class="image_thumb">
						<img src="<?php echo URL_BASE;?>upload/product/product13.jpg" height="50">
						<div class="clear"></div>
					</div>
					...
					<td class="option textC">
							...
							<img src="<?php echo URL_BASE;?>/templates/admin/images/icons/color/star.png" />
						</a>
					...
					<td>
					<div class="image_thumb">
						<img src="<?php echo URL_BASE;?>upload/product/product7.jpg" height="50">
						<div class="clear"></div>
					</div>
					...
					<td>
					<div class="image_thumb">
						<img src="<?php echo URL_BASE;?>upload/product/product6.jpg" height="50">
						<div class="clear"></div>
					</div>
					...
					<td>
					<div class="image_thumb">
						<img src="<?php echo URL_BASE;?>upload/product/product5.jpg" height="50">
						<div class="clear"></div>
					</div>
					...
					<td>
					<div class="image_thumb">
						<img src="<?php echo URL_BASE;?>upload/product/product4.jpg" height="50">
						<div class="clear"></div>
					</div>
					...
					<td>
					<div class="image_thumb">
						<img src="<?php echo URL_BASE;?>upload/product/product3.jpg" height="50">
						<div class="clear"></div>
					</div>
					...
					<td>
					<div class="image_thumb">
						<img src="<?php echo URL_BASE;?>upload/product/product1.jpg" height="50">
						<div class="clear"></div>
					</div>
					...
					<td>
					<div class="image_thumb">
						<img src="<?php echo URL_BASE;?>upload/product/product2.jpg" height="50">
						<div class="clear"></div>
					</div>
