...
<form class="form" id="form" action="product/add.html" method="post" enctype="multipart/form-data">
	<fieldset>
		<div class="widget">
			<div class="title">
				<img src="<?php echo URL_BASE;?>/templates/admin/images/icons/dark/add.png" class="titleIcon" />
					...
					<div class="formRow">
						...
						<div class="formRight">
							<span class="oneTwo">
								...
								<img class='tipS' title='Giá bán sử dụng để giao dịch' style='margin-bottom:-8px'  src='<?php echo URL_BASE;?>/templates/admin/crown/images/icons/notifications/information.png'/>
							</span>
					...
					<div class="formRow">
						...
						<div class="formRight">
							<span>
								...
								<img class='tipS' title='Số tiền giảm giá' style='margin-bottom:-8px'  src='<?php echo URL_BASE;?>/templates/admin/crown/images/icons/notifications/information.png'/>
							</span>
